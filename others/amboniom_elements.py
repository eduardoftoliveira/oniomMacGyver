...
class prmtop():
    ...
    def _gen_gaff_uppercase(self):
        ...
        for atomtype in set(amber_type_list):
        ...
        if len(retype) > 0:
            print ('** lowercase atom types (GAFF, GLYCAM) retyped:')
            print ('---------------')
            print ('original -> new')
            print ('---------------')
            for r in retype:
            ...
            print ('---------------')
            print ('\nNOTE:')
            print (' retyping link-atoms will solve missing parameters ;)\n')
        ...
        for atomtype in amber_type_list:
            if atomtype in retype:
                ...
                new_amber_type.append(atomtype.upper())
